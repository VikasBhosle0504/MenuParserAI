...
exports.processMenuUpload = functions
  .region('us-central1')
  ...
  .onFinalize(async (object) => {
    ...
    await db.collection('menus').doc(docId).set(docData);
...
exports.processMenuUploadDocumentAI = require('./documentai').processMenuUploadDocumentAI;
